...
Prototype Ionic d un SaaS qui orchestre une equipe d agents IA pour aider une
...
- Architecture: couches SaaS, Data Hub, MCP, gouvernance et roadmap.
- Admin Console: modules activables, limites de cout et choix d outils.
